...
export function ProblemsTable({
  ...
  return (
    <div className={`overflow-hidden rounded-[26px] border ${
      ...
      <div
        className={`${SHARED_GRID} border-b py-3 text-[11px] font-semibold uppercase tracking-[0.08em] ${
          isDark
      ...
      <div className="max-h-[560px] overflow-y-auto pebble-scrollbar p-2">
        {rows.map((problem) => {
          ...
          return (
            <button
              ...
              className={`${SHARED_GRID} mb-1.5 w-full rounded-[18px] border py-3 text-left transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pebble-accent/45 ${
                isDark
