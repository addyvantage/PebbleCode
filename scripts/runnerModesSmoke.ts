...
import { fromLegacyCodeLanguageId } from '../shared/languageRegistry.ts'
import {
...
type FunctionLanguageLegacy = 'python' | 'javascript' | 'cpp' | 'java' | 'c'
...
const FUNCTION_CORRECT: Record<FunctionLanguageLegacy, string> = {
...
const FUNCTION_WRONG: Record<FunctionLanguageLegacy, string> = {
  python: 'class Solution:\n    def solve(self):\n        return "Nope"\n',
  javascript: 'class Solution {\n  solve() {\n    return "Nope"\n  }\n}\n',
  cpp: '#include <string>\nusing namespace std;\n\nclass Solution {\npublic:\n  string solve() {\n    return "Nope";\n  }\n};\n',
  java: 'class Solution {\n  public String solve() {\n    return "Nope";\n  }\n}\n',
...
async function runFunctionModeFor(language: FunctionLanguageLegacy) {
...
async function main() {
  ...
  for (const language of ['python3', 'javascript', 'cpp17', 'java17', 'c'] as const) {
